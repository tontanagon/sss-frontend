    ...
    <tbody>
      <Disclosure>
        <tr className="bg-white border-b border-gray-200">
          <td className="px-4 py-2 md:text-sm text-lg font-semibold text-[#1D3557]" data-label="รหัสการจอง">
            {data.booking_number}
          </td>
          <DisclosureButton
            as="td"
            data-label="ชื่อกิจกรรม"
          ...
          >
            <div className="flex items-center gap-2 w-full">
              ...
              />
              <div
                className={`text-sm font-semibold ${NotoSansThaiLooped.className}`}
              >
                {data.activity_name}
              </div>
            </div>
          ...
          <td className="md:text-end px-4 py-2" data-label="จำนวนรายการ">
            {data.item_booking_histories.length}
          </td>
        ...
        <DisclosurePanel transition as="tr" className="bg-[#F6F6F6] hidden-activity-name md:table-row transition duration-150 ease-in-out data-closed:-translate-y-2 data-closed:opacity-0">
          <td colSpan={7}>
            <div className="p-4">
